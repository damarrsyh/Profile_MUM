...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center bg-white" href="/dashboard/index">
                <div class="sidebar-brand-icon">
                    <img src="/assets/media/img/mum/logo.png" width="25px" height="25px">
                </div>
                <div class="sidebar-brand-text mx-3 text-dark">Admin Page</div>
            </a>
